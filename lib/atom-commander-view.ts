...
const TabbedView = require('./views/tabbed-view');

module.exports =
(AtomCommanderView = (function() {
  AtomCommanderView = class AtomCommanderView extends View {
    static initClass() {
    ...
    constructor(main, state){
      ...
      if ((this.sizeColumnVisible == null)) {
        this.sizeColumnVisible = false;
      }

      if ((this.dateColumnVisible == null)) {
        this.dateColumnVisible = false;
      }

      if ((this.extensionColumnVisible == null)) {
        this.extensionColumnVisible = true;
      }
