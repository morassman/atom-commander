    ...
    (TaskManager = /** @class */ (function () {
        ...
        TaskManager.prototype.uploadItemsWithQueue = function (remoteParentPath, items, callback) {
            ...
            return (function () {
                ...
                for (var _i = 0, _a = Array.from(items); _i < _a.length; _i++) {
                    ...
                    if (!item.isLink()) {
                        if (item.isFile()) {
                            result.push(_this.uploadFileWithQueue(remoteParentPath, item, callback));
                        }
                        else {
                            result.push(_this.uploadDirectoryWithQueue(remoteParentPath, item, callback));
                        }
                    }
                    else {
        ...
        TaskManager.prototype.uploadDirectoryWithQueue = function (remoteParentPath, directory, callback) {
            ...
            var task1 = function (cb) {
                return _this.fileSystem.makeDirectory(remoteFolderPath, cb);
            };
